Ext.define('mysqlNotas.controller.Notas',{
    ...
    var editNota = Ext.create('mysqlNotas.view.forms.EditorNotas', {title: title});
  ...
  doEdit: function(data) {
	Ext.Ajax.request({
		...
		success: function(response){
			...
			Ext.Msg.alert('Result', response.responseText, this.loadNotes);
		},
	...
	logout : function(){
		...
		sessionStore.sync();
		Ext.Viewport.animateActiveItem(Ext.create('mysqlNotas.view.forms.login'),this.flipTopTransition);
	},
	loginUser: function(){
		...
		Ext.Ajax.request({
			...
			success: function(response, opts) {
				...
				if(!data.success){
					...
					formView.destroy();
					Ext.Viewport.add(Ext.create('mysqlNotas.view.Main'));
				}
			}
